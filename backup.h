...
protected:
	...
	void InitializeGui()
	{
		...
		tbx1.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_HSCROLL | WS_TABSTOP | WS_VISIBLE | WS_VSCROLL | ES_AUTOHSCROLL | ES_MULTILINE | ES_LEFT | ES_WINNORMALCASE, 21, 28, 427, 320, hWnd, 1000);
